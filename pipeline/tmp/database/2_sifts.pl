...
system("wget -q http://purl.obolibrary.org/obo/go/go-basic.obo -O $rootdir/obo/go/go-basic.obo");
system("wget -q http://current.geneontology.org/ontology/go-basic.obo -O $rootdir/obo/go/go-basic.obo") if (!-s "$rootdir/obo/go/go-basic.obo");
...
system("wget -q http://ftp.uniprot.org/pub/databases/uniprot/current_release/knowledgebase/complete/uniprot_sprot.fasta.gz -O $rootdir/uniprot/current_release/knowledgebase/complete/uniprot_sprot.fasta.gz");
system("wget -q ftp://ftp.uniprot.org/pub/databases/uniprot/current_release/knowledgebase/complete/uniprot_sprot.fasta.gz -O $rootdir/uniprot/current_release/knowledgebase/complete/uniprot_sprot.fasta.gz") if (!-s "$rootdir/uniprot/current_release/knowledgebase/complete/uniprot_sprot.fasta.gz");
...
foreach my $filename(("pdb_chain_uniprot.tsv.gz",
                      ...
                      "pdb_chain_go.tsv.gz"))
{
    system("wget -q http://ftp.ebi.ac.uk/pub/databases/msd/sifts/flatfiles/tsv/$filename -O $rootdir/sifts/flatfiles/tsv/$filename");
    system("wget -q ftp://ftp.ebi.ac.uk/pub/databases/msd/sifts/flatfiles/tsv/$filename -O $rootdir/sifts/flatfiles/tsv/$filename") if (!-s "$rootdir/sifts/flatfiles/tsv/$filename");
}

system("mkdir -p $rootdir/taxonomy");
system("wget -q http://ftp.ncbi.nih.gov/pub/taxonomy/taxdump.tar.gz -O $rootdir/taxonomy/taxdump.tar.gz");
system("wget -q  ftp://ftp.ncbi.nih.gov/pub/taxonomy/taxdump.tar.gz -O $rootdir/taxonomy/taxdump.tar.gz") if (!-s "$rootdir/taxonomy/taxdump.tar.gz");
