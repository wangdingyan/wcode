...
def protprep(input_file,
    ...
    cmd = f'{TPATH.PROTEINPREP}  {input_file} {outputfile_basename} -fillsidechains -disulfides -assign_all_residues -rehtreat -max_states 4 -epik_pH 7.4 -epik_pHt 2.0 -antibody_cdr_scheme Kabat -samplewater -propka_pH 7.4 -fix -f S-OPLS -rmsd 0.3 -watdist 5.0 -WAIT -HOST localhost:16'
